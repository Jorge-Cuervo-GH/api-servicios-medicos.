...
public class PacienteController {
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListaPaciente>> listarPaciente(@PageableDefault(
    ...
    @PutMapping
    @Transactional
    public ResponseEntity atualizarpaciente(@RequestBody @Valid DatosActualizacionPaciente datos) {
